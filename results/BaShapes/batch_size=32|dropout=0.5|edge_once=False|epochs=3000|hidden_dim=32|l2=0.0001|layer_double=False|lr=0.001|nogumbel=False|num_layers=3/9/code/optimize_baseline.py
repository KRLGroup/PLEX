...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',  default='Mutagenicity', type=str, help='Dataset to use')
    parser.add_argument('--n_jobs',  default=25, type=int, help='Number of jobs')
